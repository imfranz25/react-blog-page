    ...
    <section id="about" className="pt-5 pt-md-3">
      <div className="container py-lg-5">
        <h1
          ...
          id="about_title"
        >
          <span className="text-warning">A</span>bout Me
        </h1>
        <div className="row mb-5">
          <label
            className="col-12 text-muted m-0 p-0 mb-4 mb-md-5 text-center"
            data-aos="fade"
            data-aos-delay="300"
            data-aos-duration="300"
          >
          ...
          <div className="col-lg-4 mb-3 mb-lg-0 d-lg-flex justify-content-center align-items-center d-none">
            ...
            <img
              src={Laya}
              alt="Laya at Diwa - CVSU"
              className="about-img rounded-circle img-fluid"
              data-aos="zoom-in-up"
              data-aos-delay="1000"
