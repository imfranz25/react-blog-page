    ...
    <>
      <footer class="container-fluid bg-dark text-white footer-text" id="contact">
        ...
        <p class="d-flex align-items-center justify-content-center p-0 m-0 pb-2 pb-lg-0">
            Contact :
            <a target="_blank" href="mailto:francis.ong25@gmail.com" class="text-nowrap home-link mx-1" rel="noreferrer"><FaEnvelope /></a>
        ...
        <div class="row">
          ...
          <div class="col-12 d-flex justify-content-center align-items-center mb-3">
            <p class="p-0 m-0">Made on the top of React, Bootstrap, and custom CSS & JS.</p>
          </div>
        </div>
      </footer>
      <button class="m-5 bg-warning border-0 p-0 rounded d-none" id="nav-home">
        <a href="#home" class="px-3" rel="noreferrer">
          <i><FaArrowUp /></i>
        </a>
      </button>
    </>
